...
// LiquidityMigrator helps your migrate your existing Uniswap LP tokens to SushiSwap LP ones
contract LiquidityMigrator {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'LiquidityMigrator: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'LiquidityMigrator: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'LiquidityMigrator: INSUFFICIENT_B_AMOUNT');
    }
